...
import udem.edu.co.abstractas.Cuadrupedo;
 ...
 * @author julio
 */
public class Perro extends Cuadrupedo implements Servivo{
    ...
    public String toString() {
        return "Perro{" + "nombre=" + nombre + ", reino=" + reino + ", color=" + color + ", Longevidad=" + Longevidad + ", promediovida=" + promediovida + '}';
    }

    public Perro(String nombre, String reino, String color, float Longevidad, float promediovida) {
        this.nombre = nombre;
        this.reino = reino;
        this.color = color;
